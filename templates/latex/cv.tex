...
% En caso de utilizar XeLaTeX, se tiene que mover los `labelitemi` un poco para arriba.
\AtEndPreamble{
...
\begin{document}
\makecvtitle
\vspace{-0.3in} % Espacio negativo agregado para que no haya tanto espacio en blanco.
<< body >>
